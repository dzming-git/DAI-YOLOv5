...
from yolov5_src.models.yolo import ClassificationModel, Detect, DetectionModel, SegmentationModel
from yolov5_src.utils.dataloaders import LoadImages
from yolov5_src.utils.general import (LOGGER, Profile, check_dataset, check_img_size, check_requirements, check_version,
                           check_yaml, colorstr, file_size, get_default_args, print_args, url2file, yaml_save)
from yolov5_src.utils.torch_utils import select_device, smart_inference_mode
...
def export_saved_model(model,
    ...
    from yolov5_src.models.tf import TFModel
...
def export_tflite(keras_model, im, file, int8, data, nms, agnostic_nms, prefix=colorstr('TensorFlow Lite:')):
    ...
    if int8:
        from yolov5_src.models.tf import representative_dataset_gen
